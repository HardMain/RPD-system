...
export const PDF_SECTION_PATTERNS = [
  ...
  { key: "6.3", re: /6[.\s]+3[.\s]+(?:Лицензионное|Программное|Перечень\s+(?:лицензион|программн))/i },
  { key: "6.4", re: /6[.\s]+4[.\s]+(?:Современные|Базы|Профессиональные|Перечень\s+(?:информац|профессион))/i },
