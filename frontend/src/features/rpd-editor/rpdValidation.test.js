...
const fullRpd = {
  ...
  learning_outcomes: [{
    competency_code: "ОПК-1", indicator_code: "ИД-1ОПК-1",
    indicator_description: "Знает основные положения и методы математики",
    outcome_text: "Знает основы", assessment_tool: "Экзамен",
  }],
  sections: [{
  ...
  topics: [],
  literature: [
    { title: "Учебник", url: null, copies_count: 5 },
    { source_type: "Основная литература", title: "Электронный ресурс", url: "https://e.lanbook.com", availability: ["сеть Интернет", "свободный доступ"] },
  ],
  software: [{ name: "VS Code", license_type: "Среды разработки, тестирования и отладки" }],
  databases: [{ name: "Лань", url: "https://e.lanbook.com" }],
  material_tech: [{ room_type: "Лекционная аудитория", equipment: "Проектор", quantity: 1 }],
