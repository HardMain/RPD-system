...
DEFAULT_LLM_PROMPTS: list[dict] = [
    ...
    },
    {
        ...
        "user_prompt_template": (
            ...
            "КРИТИЧНО про URL (это основная проблема выдумывания):\n"
            ...
            "- Допустимые варианты URL:\n"
            "  • главная страница реальной платформы без конкретного пути: «https://e.lanbook.com/», "
            "«https://urait.ru/», «https://znanium.com/», «https://elib.pstu.ru/», "
            "«https://www.iprbookshop.ru/», «https://elibrary.ru/».\n"
            "  • пустая строка \"\" — если не знаешь точного URL.\n"
...
_STYLE_MARKERS: dict[str, str] = {
    ...
    "literature_electronic": "Дубликаты той же книги",
